...
var pinnacleOdds = new Datastore({ filename: './data/nba/pinnacleOdds.db', autoload: true });
var betclicOdds = new Datastore({ filename: './data/nba/betclicOdds.db', autoload: true });
var winamaxOdds = new Datastore({filename: "./data/nba/winamaxOdds.db", autoload: true});
var unibetOdds = new Datastore({ filename: './data/nba/unibetOdds.db', autoload: true });
var bwinOdds = new Datastore({ filename: "./data/nba/bwinOdds.db", autoload: true});

// NBA, betclic
module.exports = {
pickOddsNBAWinamax: function(){
	console.log("twice");
  var fs = require("fs");
  var start = new Date().getTime();
  var Horseman = require('node-horseman');
  var horseman = new Horseman();
  fs.appendFile("log/nba.log", "Retrieving nba games odds on Winamax\n", (err) => {
	
  });
  horseman
      .userAgent('Chrome/54.0.2840.87')
      .openTab('http://www.winamax.fr/paris-sportifs/sports/2/800000076/10561')
      .catch(function(err){
        fs.appendFile("log/nba.log", err + "\n", (err) => {
  ...
  .evaluate( function(selector1, selector2, selector3, selector4){
	...
	time: time
      ...
      .then(function(games){
        fs.appendFile("log/nba.log", 'Successfully retrieved odds on Winamax\n', (err) => {
  ...
  winamaxOdds.insert(games, function (err, newDoc) {
	...
	var nb_odds = games.length;
        fs.appendFile("log/nba.log", "It took " + (end-start)/1000 + " seconds to retrieve " + nb_odds + " odds. Date : " + date + "\n");
        return horseman.close();
      });

},

pickOddsNBABwin: function(){
  var fs = require("fs");
  var start = new Date().getTime();
  var Horseman = require('node-horseman');
  var horseman = new Horseman();
  fs.appendFile("log/nba.log", "Retrieving nba games odds on Bwin...\n", (err) => {
  ...
  horseman
	...
	.evaluate( function(selector1){
		...
		for (var i = 0; i < ngames; i++) {  
			...
			//matchs NBA
			if ($(selector1)[i].innerText.search("NBA") != -1) { 
	...
	bwinOdds.insert(games, function (err, newDoc) {
        ...
        fs.appendFile("log/nba.log", 'Successfully retrieved odds on Bwin\n', (err) => {
...
pickOddsNBAPinnacle: function(){
   var fs = require("fs");
  var start = new Date().getTime();
  var Horseman = require('node-horseman');
  var horseman = new Horseman();
  fs.appendFile("log/nba.log", "Retrieving nba games odds on Pinnacle...\n", (err) => {
  ...
  horseman
      ...
      .then(function(games){
        fs.appendFile("log/nba.log", 'Successfully retrieved odds on Pinnacle\n', (err) => {
...
pickOddsNBABetclic: function(){
  var fs = require("fs");
  var start = new Date().getTime();
  var Horseman = require('node-horseman');
  var horseman = new Horseman();
  fs.appendFile("log/nba.log", "Retrieving nba games odds on Betclic...\n", (err) => {
  ...
  horseman
    ...
    .evaluate( function(selector1,selector2){
      ...
      .then(function(games){
        fs.appendFile("log/nba.log", 'Successfully retrieved odds on Betclic: \n', (err) => {
...
pickOddsNBAUnibet: function(){
  var fs = require("fs");
  var start = new Date().getTime();
  var Horseman = require('node-horseman');
  var horseman = new Horseman();
  fs.appendFile("log/nba.log", "Retrieving nba games odds on Unibet...\n", (err) => {
  ...
  horseman
    ...
    .evaluate( function(selector1,selector2){
      ...
      .then(function(games){
        fs.appendFile("log/nba.log", 'Successfully retrieved odds on Unibet: \n', (err) => {
